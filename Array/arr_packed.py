from null_libs import FParser, oddNeven, isPrime
from statistics import mean
from itertools import combinations
fi = [None, open("io/1_SEQREAL.inp", "r"),open("io/2_MINMAX.inp", "r"),open("io/3_TBC.inp", "r"),open("io/4_POS.inp", "r"),open("io/5_ARRSORT.inp", "r"),open("io/6_PRIME.inp", "r"),open("io/7_PNUMBER.inp", "r"),open("io/8_BOBASO.inp", "r"),open("io/9_capso1.inp", "r"),open("io/10_capso2.inp", "r"),open("io/11_capso3.inp", "r"),open("io/12_dprime.inp", "r"),open("io/13_DOANCON1.inp", "r"),open("io/14_DOANCON2.inp", "r"),open("io/15_DOANCON3.inp", "r"),open("io/16_PHANTICH.inp", "r"),open("io/17_TANSO.inp", "r"),open("io/18_CD.inp", "r"),open("io/19_HOMEWORK.inp", "r"),open("io/20_COW.inp", "r")]
fo = [None, open("io/1_SEQREAL.out", "w"),open("io/2_MINMAX.out", "w"),open("io/3_TBC.out", "w"),open("io/4_POS.out", "w"),open("io/5_ARRSORT.out", "w"),open("io/6_PRIME.out", "w"),open("io/7_PNUMBER.out", "w"),open("io/8_BOBASO.out", "w"),open("io/9_capso1.out", "w"),open("io/10_capso2.out", "w"),open("io/11_capso3.out", "w"),open("io/12_dprime.out", "w"),open("io/13_DOANCON1.out", "w"),open("io/14_DOANCON2.out", "w"),open("io/15_DOANCON3.out", "w"),open("io/16_PHANTICH.out", "w"),open("io/17_TANSO.out", "w"),open("io/18_CD.out", "w"),open("io/19_HOMEWORK.out", "w"),open("io/20_COW.out", "w")]
